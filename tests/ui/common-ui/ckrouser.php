...
/**
 * Verify that only the home browse and help menu's exist for this user
 *
 * @version "$Id: ckrouser.php 4169 2011-04-29 18:27:44Z rrando $"
 *
...
class ckrouserTest extends fossologyTestCase
{

  function testRouserMenus()
  {
    global $URL;
    $this->Login('rouser', '');
    ...
    $this->assertFalse($this->myassertText($loggedIn, '/>My Account</'),
      "Fail! My Account menu found, it should not be visible");
  }
}
?>
