...
/**
 * Verify that the correct menus are visible for the analyze user/perms
 *
 * @version "$Id: ckanauser.php 4169 2011-04-29 18:27:44Z rrando $"
 *
...
class ckAnaUserTest extends fossologyTestCase
{

  function testAnalyzeMenus()
  {
    global $URL;
    $this->Login('anauser', '');
    ...
    $this->assertTrue($this->myassertText($page,'/>Bucket Analysis</'),
      "Fail! Phrase Bucket Analysis NOT found");
    $this->assertTrue($this->myassertText($page,'/License Analysis</'),
      "Fail! Phrase License Analysis NOT found");
  }
}
?>
